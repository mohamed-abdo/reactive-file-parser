...
namespace SoftIdeas.IOHandler.JSAdapter
{
    public class JSParser : BaseContentParserAdaptee, IContentParserAdapter, IContentParserReactiveAdapter
    {
        protected override string ContentType => "js";

        /// <summary>
        /// JS contents parser for stream contents
        /// </summary>
        ...
        /// <summary>
        /// JS contents parser for stream contents reactively, and return array of bytes contents on next callback once chunk size filled out, suitable for large stream contents.
        /// </summary>
